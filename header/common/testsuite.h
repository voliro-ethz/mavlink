...
static void mavlink_test_vologging(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_VOLOGGING >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_vologging_t packet_in = {
        963497464,{ 45.0, 46.0, 47.0 },{ 129.0, 130.0, 131.0 },{ 213.0, 214.0, 215.0 },{ 297.0, 298.0, 299.0 },{ 381.0, 382.0, 383.0 },{ 465.0, 466.0, 467.0 }
    };
    mavlink_vologging_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_boot_ms = packet_in.time_boot_ms;
        
        mav_array_memcpy(packet1.port_A_1, packet_in.port_A_1, sizeof(float)*3);
        mav_array_memcpy(packet1.port_A_2, packet_in.port_A_2, sizeof(float)*3);
        mav_array_memcpy(packet1.port_A_3, packet_in.port_A_3, sizeof(float)*3);
        mav_array_memcpy(packet1.port_A_4, packet_in.port_A_4, sizeof(float)*3);
        mav_array_memcpy(packet1.port_A_5, packet_in.port_A_5, sizeof(float)*3);
        mav_array_memcpy(packet1.port_A_6, packet_in.port_A_6, sizeof(float)*3);
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_VOLOGGING_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_VOLOGGING_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_vologging_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_vologging_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_vologging_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.port_A_1 , packet1.port_A_2 , packet1.port_A_3 , packet1.port_A_4 , packet1.port_A_5 , packet1.port_A_6 );
    mavlink_msg_vologging_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_vologging_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.port_A_1 , packet1.port_A_2 , packet1.port_A_3 , packet1.port_A_4 , packet1.port_A_5 , packet1.port_A_6 );
    mavlink_msg_vologging_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_vologging_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_vologging_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.port_A_1 , packet1.port_A_2 , packet1.port_A_3 , packet1.port_A_4 , packet1.port_A_5 , packet1.port_A_6 );
    mavlink_msg_vologging_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_voliro_alpha(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_VOLIRO_ALPHA >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_voliro_alpha_t packet_in = {
        963497464,{ 45.0, 46.0, 47.0, 48.0, 49.0, 50.0 }
    };
    mavlink_voliro_alpha_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_boot_ms = packet_in.time_boot_ms;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_VOLIRO_ALPHA_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_VOLIRO_ALPHA_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_alpha_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_voliro_alpha_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_alpha_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.alpha );
    mavlink_msg_voliro_alpha_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_alpha_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.alpha );
    mavlink_msg_voliro_alpha_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_voliro_alpha_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_alpha_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.alpha );
    mavlink_msg_voliro_alpha_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_voliro_full_setpoint(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_VOLIRO_FULL_SETPOINT >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_voliro_full_setpoint_t packet_in = {
        963497464,45.0,73.0,101.0,{ 129.0, 130.0, 131.0, 132.0 },241.0,269.0,297.0,325.0,353.0,381.0,173,240,51,118,185,252
    };
    mavlink_voliro_full_setpoint_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_boot_ms = packet_in.time_boot_ms;
        packet1.x = packet_in.x;
        packet1.y = packet_in.y;
        ...
        packet1.target_system = packet_in.target_system;
        packet1.target_component = packet_in.target_component;
        packet1.takeoff_enabled = packet_in.takeoff_enabled;
        packet1.landing_enabled = packet_in.landing_enabled;
        packet1.rotorguards_tola_enabled = packet_in.rotorguards_tola_enabled;
        packet1.velocity_enabled = packet_in.velocity_enabled;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_VOLIRO_FULL_SETPOINT_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_VOLIRO_FULL_SETPOINT_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_full_setpoint_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_voliro_full_setpoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_full_setpoint_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.target_system , packet1.target_component , packet1.takeoff_enabled , packet1.landing_enabled , packet1.rotorguards_tola_enabled , packet1.velocity_enabled , packet1.x , packet1.y , packet1.z , packet1.q , packet1.vx , packet1.vy , packet1.vz , packet1.roll_rate , packet1.pitch_rate , packet1.yaw_rate );
    mavlink_msg_voliro_full_setpoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_full_setpoint_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.target_system , packet1.target_component , packet1.takeoff_enabled , packet1.landing_enabled , packet1.rotorguards_tola_enabled , packet1.velocity_enabled , packet1.x , packet1.y , packet1.z , packet1.q , packet1.vx , packet1.vy , packet1.vz , packet1.roll_rate , packet1.pitch_rate , packet1.yaw_rate );
    mavlink_msg_voliro_full_setpoint_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_voliro_full_setpoint_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_full_setpoint_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.target_system , packet1.target_component , packet1.takeoff_enabled , packet1.landing_enabled , packet1.rotorguards_tola_enabled , packet1.velocity_enabled , packet1.x , packet1.y , packet1.z , packet1.q , packet1.vx , packet1.vy , packet1.vz , packet1.roll_rate , packet1.pitch_rate , packet1.yaw_rate );
    mavlink_msg_voliro_full_setpoint_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_voliro_ballbot_fullstate(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_VOLIRO_BALLBOT_FULLSTATE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_voliro_ballbot_fullstate_t packet_in = {
        963497464,45.0,73.0,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,137,204,15,82,149,216
    };
    mavlink_voliro_ballbot_fullstate_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_boot_ms = packet_in.time_boot_ms;
        packet1.thetaX = packet_in.thetaX;
        packet1.thetaXdot = packet_in.thetaXdot;
        packet1.thetaY = packet_in.thetaY;
        packet1.thetaYdot = packet_in.thetaYdot;
        packet1.thetaZ = packet_in.thetaZ;
        packet1.thetaZdot = packet_in.thetaZdot;
        packet1.phiX = packet_in.phiX;
        packet1.phiXdot = packet_in.phiXdot;
        packet1.phiY = packet_in.phiY;
        packet1.phiYdot = packet_in.phiYdot;
        packet1.target_system = packet_in.target_system;
        packet1.target_component = packet_in.target_component;
        packet1.start_enabled = packet_in.start_enabled;
        packet1.stop_enabled = packet_in.stop_enabled;
        packet1.flag1 = packet_in.flag1;
        packet1.flag2 = packet_in.flag2;
        
        
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_VOLIRO_BALLBOT_FULLSTATE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_VOLIRO_BALLBOT_FULLSTATE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_ballbot_fullstate_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_voliro_ballbot_fullstate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_ballbot_fullstate_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.target_system , packet1.target_component , packet1.thetaX , packet1.thetaXdot , packet1.thetaY , packet1.thetaYdot , packet1.thetaZ , packet1.thetaZdot , packet1.phiX , packet1.phiXdot , packet1.phiY , packet1.phiYdot , packet1.start_enabled , packet1.stop_enabled , packet1.flag1 , packet1.flag2 );
    mavlink_msg_voliro_ballbot_fullstate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_ballbot_fullstate_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.target_system , packet1.target_component , packet1.thetaX , packet1.thetaXdot , packet1.thetaY , packet1.thetaYdot , packet1.thetaZ , packet1.thetaZdot , packet1.phiX , packet1.phiXdot , packet1.phiY , packet1.phiYdot , packet1.start_enabled , packet1.stop_enabled , packet1.flag1 , packet1.flag2 );
    mavlink_msg_voliro_ballbot_fullstate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_voliro_ballbot_fullstate_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_ballbot_fullstate_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.target_system , packet1.target_component , packet1.thetaX , packet1.thetaXdot , packet1.thetaY , packet1.thetaYdot , packet1.thetaZ , packet1.thetaZdot , packet1.phiX , packet1.phiXdot , packet1.phiY , packet1.phiYdot , packet1.start_enabled , packet1.stop_enabled , packet1.flag1 , packet1.flag2 );
    mavlink_msg_voliro_ballbot_fullstate_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}

static void mavlink_test_voliro_ballbot_shortstate(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_VOLIRO_BALLBOT_SHORTSTATE >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_voliro_ballbot_shortstate_t packet_in = {
        963497464,45.0,73.0,101.0,129.0,157.0,77,144,211,22,89,156
    };
    mavlink_voliro_ballbot_shortstate_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.time_boot_ms = packet_in.time_boot_ms;
        packet1.thetaX = packet_in.thetaX;
        packet1.thetaY = packet_in.thetaY;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_VOLIRO_BALLBOT_SHORTSTATE_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_VOLIRO_BALLBOT_SHORTSTATE_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_ballbot_shortstate_encode(system_id, component_id, &msg, &packet1);
    mavlink_msg_voliro_ballbot_shortstate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_ballbot_shortstate_pack(system_id, component_id, &msg , packet1.time_boot_ms , packet1.target_system , packet1.target_component , packet1.thetaX , packet1.thetaY , packet1.thetaZ , packet1.phiX , packet1.phiY , packet1.start_enabled , packet1.stop_enabled , packet1.flag1 , packet1.flag2 );
    mavlink_msg_voliro_ballbot_shortstate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_ballbot_shortstate_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.target_system , packet1.target_component , packet1.thetaX , packet1.thetaY , packet1.thetaZ , packet1.phiX , packet1.phiY , packet1.start_enabled , packet1.stop_enabled , packet1.flag1 , packet1.flag2 );
    mavlink_msg_voliro_ballbot_shortstate_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_voliro_ballbot_shortstate_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
        
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_voliro_ballbot_shortstate_send(MAVLINK_COMM_1 , packet1.time_boot_ms , packet1.target_system , packet1.target_component , packet1.thetaX , packet1.thetaY , packet1.thetaZ , packet1.phiX , packet1.phiY , packet1.start_enabled , packet1.stop_enabled , packet1.flag1 , packet1.flag2 );
    mavlink_msg_voliro_ballbot_shortstate_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
}
...
static void mavlink_test_common(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_vologging(system_id, component_id, last_msg);
    mavlink_test_voliro_alpha(system_id, component_id, last_msg);
    mavlink_test_voliro_full_setpoint(system_id, component_id, last_msg);
    mavlink_test_voliro_ballbot_fullstate(system_id, component_id, last_msg);
    mavlink_test_voliro_ballbot_shortstate(system_id, component_id, last_msg);
}
